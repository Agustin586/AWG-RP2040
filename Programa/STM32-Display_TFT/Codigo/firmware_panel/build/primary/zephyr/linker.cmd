...
MEMORY
    ...
    RAM (wx) : ORIGIN = 0x24000000, LENGTH = (512 * 1K)
    EXTMEM ( rw ) : ORIGIN = (2415919104), LENGTH = (268435456) SRAM1 ( rw ) : ORIGIN = (805306368), LENGTH = (131072) SRAM2 ( rw ) : ORIGIN = (805437440), LENGTH = (131072) SRAM3 ( rw ) : ORIGIN = (805568512), LENGTH = (32768) SRAM4 ( rw ) : ORIGIN = (939524096), LENGTH = (65536) DTCM ( rw ) : ORIGIN = (536870912), LENGTH = (131072)
...
ztest :
{
 ...
 input_callback_area : { _input_callback_list_start = .; KEEP(*(SORT_BY_NAME(._input_callback.static.*))); _input_callback_list_end = .;; } > FLASH
...
noinit (NOLOAD) :
{
    ...
    __kernel_ram_end = 0x24000000 + (512 * 1K);
