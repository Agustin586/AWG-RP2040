SamacSys ECAD Model
14979759/1857803/2.50/10/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "SI5351A-B-GTR" (originalName "SI5351A-B-GTR")
	...
	(compDef "SI5351A-B-GTR" (originalName "SI5351A-B-GTR") (compHeader (numPins 10) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "VDD") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "2" (pinName "XA") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "3" (pinName "XB") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "10" (pinName "CLK0") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "9" (pinName "CLK1") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "8" (pinName "GND") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "7" (pinName "VDDO") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "CLK2") (partNum 1) (symPinNum 10) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "SI5351A-B-GTR"))
		...
		(attr "Mouser Part Number" "634-SI5351A-B-GTR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Skyworks-Solutions-Inc/SI5351A-B-GTR?qs=p9T7GgSe1IEYql%252BRMAlVcw%3D%3D")
		(attr "Manufacturer_Name" "Skyworks")
		(attr "Manufacturer_Part_Number" "SI5351A-B-GTR")
		(attr "Description" "Clock Generator 10MHz to 100MHz-IN 160MHz-OUT 10-Pin MSOP T/R")
		(attr "Datasheet Link" "https://www.mouser.de/datasheet/2/472/Si5351_B-2507774.pdf")
		(attr "Height" "1.1 mm")
	)
