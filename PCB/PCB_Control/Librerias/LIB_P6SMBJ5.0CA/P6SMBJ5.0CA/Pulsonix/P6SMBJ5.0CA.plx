...
(library Library_1
	...
	(symbolDef "P6SMBJ5.0CA" (originalName "P6SMBJ5.0CA")
	...
	(compDef "P6SMBJ5.0CA" (originalName "P6SMBJ5.0CA") (compHeader (numPins 2) (numParts 1) (refDesPrefix D)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "P6SMBJ5.0CA"))
		...
		(attr "<Hyperlink>" "https://www.mouser.de/datasheet/2/849/p6smbj65-2578601.pdf")
		(attr "<Component Height>" "2.4")
		(attr "<STEP Filename>" "P6SMBJ5.0CA.stp")
