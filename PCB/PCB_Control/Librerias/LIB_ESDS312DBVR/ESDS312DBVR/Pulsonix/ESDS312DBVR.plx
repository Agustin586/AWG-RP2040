...
//1466804/1857803/2.50/5/3/TVS Diode Uni-directional
...
(library Library_1
	...
	(symbolDef "ESDS312DBVR" (originalName "ESDS312DBVR")
	...
	(compDef "ESDS312DBVR" (originalName "ESDS312DBVR") (compHeader (numPins 5) (numParts 1) (refDesPrefix D)
		)
		...
		(compPin "4" (pinName "I/O1") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "I/O2") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ESDS312DBVR"))
		...
		(attr "Mouser Part Number" "595-ESDS312DBVR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/ESDS312DBVR?qs=byeeYqUIh0PGNqB7QuJpTA%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "ESDS312DBVR")
		(attr "Description" "3.6V Data-Line Surge and 30kV ESD Protection Diode Array")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/esds312")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "ESDS312DBVR.stp")
